 ...
 */ class $08115c74b7a4e0bd$export$2e2bcd8739ae039 {
     ...
     */ interpolate(other, t) {
        ...
        return new $08115c74b7a4e0bd$export$2e2bcd8739ae039(x, y);
    }
    /**
     * Returns a Vector2 instance with both components set to zero.
     * @returns The zero vector.
     */ static zero() {
        return new $08115c74b7a4e0bd$export$2e2bcd8739ae039(0, 0);
    }
    /**
     ...
     * @param vec2 The second vector.
     * @returns The angle between the two vectors in radians.
     */ static vectorToAngle(vec1, vec2) {
     ...
     * @param t The interpolation amount (between 0 and 1).
     * @returns The interpolated vector.
     */ static interpolate(vec1, vec2, t) {
...
class $c4d1796e1253327f$export$2e2bcd8739ae039 extends (0, $59f2c5857d98d905$export$2e2bcd8739ae039) {
    ...
    render() {
        if (!this.reference) this.reference = new (0, $08115c74b7a4e0bd$export$2e2bcd8739ae039)(0, 0);
...
class $4c348eb6c64c4710$export$2e2bcd8739ae039 {
...
class $0d012e83fb7d1e90$export$2e2bcd8739ae039 {
    ...
    constructor(frame){
        ...
        else if (!$0d012e83fb7d1e90$export$2e2bcd8739ae039.first) this.setFather((0, $f8bbed27444dc2b3$export$2e2bcd8739ae039).UI);
        else $0d012e83fb7d1e90$export$2e2bcd8739ae039.first = false;
...
class $8ef0dd47308bf20d$export$2e2bcd8739ae039 {
    constructor(path){
...
class $88f08228c341c278$export$2e2bcd8739ae039 {
    ...
    static angleRelativeToTarget(reference, target) {
        ...
        const vectorA = new (0, $08115c74b7a4e0bd$export$2e2bcd8739ae039)(size.width / 2, 0);
        const midVector = new (0, $08115c74b7a4e0bd$export$2e2bcd8739ae039)(reference.transform.x + size.width / 2, reference.transform.y + size.height / 2);
        const vectorB = target.subtract(midVector);
        return (0, $4c348eb6c64c4710$export$2e2bcd8739ae039).radianToDegress(vectorA.vectorToAngle(vectorB)) * (target.y > midVector.y ? 1 : -1);
    }
}
...
class $f8bbed27444dc2b3$export$d36076abcf594543 {
    ...
    constructor(config){
        ...
        if (!Number.isNaN(parseInt(source.split("#").join(""), 16))) this.background = new (0, $c4d1796e1253327f$export$2e2bcd8739ae039)($f8bbed27444dc2b3$export$d36076abcf594543.window.WIDTH, $f8bbed27444dc2b3$export$d36076abcf594543.window.HEIGHT, source);
        else {
    ...
    start() {
        ...
        $f8bbed27444dc2b3$export$d36076abcf594543.GameObjects.forEach((g)=>g.gameStart());
