 ...
 */ class $fbe8591a509f65b2$export$2e2bcd8739ae039 {
     ...
     */ interpolate(other, t) {
        ...
        return new $fbe8591a509f65b2$export$2e2bcd8739ae039(x, y);
    }
    /**
     * Returns a Vector2 instance with both components set to zero.
     * @returns The zero vector.
     */ static zero() {
        return new $fbe8591a509f65b2$export$2e2bcd8739ae039(0, 0);
    }
    /**
...
class $bcca9c904f06c83e$export$2e2bcd8739ae039 {
    ...
    frameUpdate() {
        this.frameCount++;
        if (this.currentTime > this.lastFrameTime + (0, $5e379901baf0d859$export$2e2bcd8739ae039).SECOND) {
...
class $be9b019dcf88b1d2$export$d36076abcf594543 {
    ...
    constructor(config){
        ...
        window.addEventListener("focus", ()=>{
            if ($be9b019dcf88b1d2$export$d36076abcf594543.state == (0, $a7f36dda3f4a8094$export$2e2bcd8739ae039).STOPPED) $be9b019dcf88b1d2$export$d36076abcf594543.resume();
        });
        window.addEventListener("blur", ()=>$be9b019dcf88b1d2$export$d36076abcf594543.stop());
    }
